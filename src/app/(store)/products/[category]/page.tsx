...
export default async function CategoryPage(props: { params: Promise<{category: string}>}) {
    ...
    return (
        <div className='max-w-7xl mx-auto px-4 py-12'>
            <div className='bg-gradient-to-r from-[#003d5b] to-[#00798c] rounded-2x1 p-8 mb-12 text-white relative overflow-hidden'> 
                <div className='relative z-10'>
                    <h1 className='text-4xl font-bold mb-3'>{categoryName}</h1>
                    <p className='text-lg text-white/80 max-w-2x1'>{categoryDescription}</p>
                </div>
            </div>
